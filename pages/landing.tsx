...
<section className="bg-black">
    <div className="relative px-16 pt-20 pb-32 mx-auto max-w-7xl xl:px-16">
      ...
      >
        ...
        <g fillRule="nonzero">
          ...
          <path d="M14.499 21.55v-.1a.54.54 0 010 .1zM41.874 10c.462-1.423-.366-2.884-2.197-3.876A.87.87 0 0139.522 6c-1.373.757.287 2.644 1.266 3.49.303.209.671.382 1.086.51zM40.5 9.505v-.01z" />
        </g>
      </svg>
      <div className="relative z-20">
        ...
        <div className="flex flex-col mt-14 sm:flex-row sm:items-center">
          ...
          <div className="flex mt-5 space-x-1 sm:mt-1 sm:ml-3">
            <div className="w-10 h-2 bg-yellow-300 rounded-full opacity-100" />
            <div className="w-8 h-2 bg-yellow-300 rounded-full opacity-75" />
            <div className="w-4 h-2 bg-yellow-300 rounded-full opacity-50" />
            <div className="w-3 h-2 bg-yellow-300 rounded-full opacity-25" />
            <div className="w-2 h-2 bg-yellow-300 rounded-full opacity-10" />
            <div className="w-2 h-2 bg-yellow-300 rounded-full opacity-5" />
          </div>
        </div>
      </div>
      <div className="grid grid-cols-1 mt-24 gap-14 lg:grid-cols-3">
        ...
        <div className="flex text-white">
          ...
          <div className="relative space-y-2">
            ...
            <p className="text-lg text-gray-300">
              All templates can be easily be exported and imported into any of
              your applications.
            </p>
          </div>
        </div>
        <div className="flex text-white">
          ...
          <div className="relative space-y-2">
            ...
            <p className="text-lg text-gray-300">
              Change the text, color, font, and many other aspects to make it
              your own.
            </p>
          </div>
        </div>
  ...
  <section className="flex flex-col w-full bg-black md:flex-row">
    <div className="flex flex-col items-center justify-center w-full p-10 md:w-1/2 lg:p-16 xl:p-24">
      ...
      <p className="max-w-lg mt-5 text-xl text-gray-500 md:text-base lg:text-xl">
        Our powerful and revolutionary tools are designed to help your business
        thrive.
      </p>
    </div>
  ...
  export async function getStaticProps(){
    const response = await fetch("http://localhost:1337/api/title");
    const getstarted=await response.json();
